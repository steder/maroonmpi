...
/*
  ...
  This file will define the MPI_Graph_* functions.  
*/

#ifndef MMPIMODULE_GRAPH_H
#define MMPIMODULE_GRAPH_H
...
/* Prototypes */
static PyObject *mmpi_graph_create(PyObject * self, PyObject * args);
